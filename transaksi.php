                                    ...
                                    <?php foreach ($transaksi as $tr) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-hapus<?= $tr["id"]; ?>">Hapus</button>
                                            </td>
                                        </tr>
                                        <!-- Modal add Data -->
                                        ...
                                        <!-- Modal add Data -->
                                        <div class="modal fade" id="modal-hapus<?= $tr["id"]; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form action="" method="POST">
                                                        <div class="modal-footer ml-auto">
                                                            <a href="hapustransaksi.php?id=<?= $tr['id']; ?>" type="button" class="btn btn-danger">Hapus Data</i></a>
                                                        </div>
                                                </div>
                                                </form>
                                            </div>
